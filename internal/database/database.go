...
// Database struct for a wrapper around sql.DB which keeps track of the driverName upon Open
...
// Ping - returns an error for pinging the database and testing connection
